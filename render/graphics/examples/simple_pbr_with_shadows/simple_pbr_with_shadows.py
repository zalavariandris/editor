...
def on_draw():
    ...
    with puregl.program.use(lambert_program):
        ...
        puregl.program.set_uniform(lambert_program, "cameraPos", viewer.camera.position)
        ...
        for mesh in scene.meshes():
            ...
            puregl.program.set_uniform(lambert_program, "material.albedo", mesh.material.albedo)
            puregl.program.set_uniform(lambert_program, "material.emission", mesh.material.emission)
            puregl.program.set_uniform(lambert_program, "material.roughness", mesh.material.roughness)
            puregl.program.set_uniform(lambert_program, "material.metallic", mesh.material.metallic)
